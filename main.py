...
from Backend_Calculation import *
...
class App:  # All the GUI things is in here
    ...
    def polygon_choosed(self, value):
        ...
        self.rlist = [] # result list to destroy later
    ...
    def Calculate(self, types, value):
        ...
        match types[0]:
            case "triangle":
                match types[1]:
                    case "Area":
                        result = triangle_area(value)
                        print(result)
                        if result != False:
                            self.Results(result)
                    case "Perimeter":
                        result = triangle_perimeter(value)
                        print(result)
                        if result != False:
                            self.Results(result)
            case "square":
                match types[1]:
                    case "Area":
                        result = square_area(value)
                        print(result)
                        if result != False:
                            self.Results(result)
                    case "Perimeter":
                        print(value)
                        result = square_perimeter(value)
                        if result != False:
                            self.Results(result)
            case "pentagon":
                match types[1]:
                    case "Area":
                        print(value)
                        result = pentagon("Area", float(value))
                        self.Results(result)
                    case "Perimeter":
                        print(value)
                        result = pentagon("Perimeter", float(value))
                        self.Results(result)
            case "hexagon":
                match types[1]:
                    case "Area":
                        print(value)
                        result = hexagon("Area", float(value))
                        self.Results(result)
                    case "Perimeter":
                        print(value)
                        result = hexagon("Perimeter", float(value))
                        self.Results(result)
    ...
    def Results(self, results):
        ...
        f_results = self.create_frame(self.f_input)
        f_results.config(padx=20)
        self.rlist.append(f_results)
        f_results.grid(row=0, column=2, rowspan=3)
        self.entry_a.delete(0, END)
        self.entry_b.delete(0, END)
        self.entry_c.delete(0, END)
        self.entry_a.insert(END, results[1])
        self.entry_b.insert(END, results[2])
        self.entry_c.insert(END, results[3])

        # Title
        font = tkFont.Font(family="Segoe UI Bold", size=20)
        title = Label(f_results, text=f"{results[0]} - Results:", font=font)
        self.rlist.append(title)
        title.pack()

        result_font = tkFont.Font(family="Segoe UI Bold", size=15)
        result_value = Label(f_results, text=str(results[4]), font=result_font)
        self.rlist.append(result_value)
        result_value.pack()
            ...
            case "triangle":
                match value[1]:
                    case "Area":
                        ...
                        text_c = Label(f_theentrys, text="Hypoteneuse: ", font=text_font)
            ...
            case "square":
                match value[1]:
                    case "Area":
                        ...
                        # Image
                        img = Image.open("Images/square.png") # Open Image
                        resized = img.resize((100,100), Image.ANTIALIAS) # Resize Image
                        test = ImageTk.PhotoImage(resized)
                        ...
                        text_a = Label(f_theentrys, text="width: ", font=text_font)
                        entry_a = Entry(f_theentrys, borderwidth=0, width=20)
                        self.entry_a = entry_a
                        text_a.grid(row=1, column=0)
                        entry_a.grid(row=1, column=1, ipady=5)
                        ...
                        text_b = Label(f_theentrys, text="Lenght: ", font=text_font)
                        entry_b = Entry(f_theentrys, borderwidth=0)
                        self.entry_b = entry_b
                        text_b.grid(row=2, column=0)
                        entry_b.grid(row=2, column=1, ipady=5)
                        ...
                        text_c = Label(f_theentrys, text="Diagonal: ", font=text_font)
                        entry_c = Entry(f_theentrys, borderwidth=0)
                        self.entry_c = entry_c
                        text_c.grid(row=3, column=0)
                        entry_c.grid(row=3, column=1, ipady=5)
            ...
            case "pentagon":
                match value[1]:
                    case "Area":
                        ...
                        # Image
                        img = Image.open("Images/pentagono.png") # Open Image
                        resized = img.resize((100,100), Image.ANTIALIAS) # Resize Image
                        test = ImageTk.PhotoImage(resized)
                        ...
                        text_a = Label(f_theentrys, text="Sides: ", font=text_font)
                        entry_a = Entry(f_theentrys, borderwidth=0, width=20)
                        self.entry_a = entry_a
                        text_a.grid(row=1, column=0)
                        entry_a.grid(row=1, column=1, ipady=5)
                        ...
                        text_b = Label(f_theentrys, text="Apotemia: ", font=text_font)
                        entry_b = Entry(f_theentrys, borderwidth=0)
                        self.entry_b = entry_b
                        text_b.grid(row=2, column=0)
                        entry_b.grid(row=2, column=1, ipady=5)
                        ...
                        calculate_button = Button(f_theentrys, text="Calculate",
                         fg="#e6e6e6", bg="#1a1a1a", font=tkFont.Font(family="Segoe UI Bold"),
                          command=lambda: self.Calculate(value, entry_a.get()))
                        self.inputlist.append(calculate_button)
                        calculate_button.grid(row=0, column=2, rowspan=5, columnspan=3, padx=20)
            ...
            case "hexagon":
                match value[1]:
                    case "Area":
                        ...
                        # Image
                        img = Image.open("Images/hexagon.png") # Open Image
                        resized = img.resize((100,100), Image.ANTIALIAS) # Resize Image
                        test = ImageTk.PhotoImage(resized)
